	...
	def define(self):
		...
		try:
			...
			(self.feed('data')
				 ...
				 .conv(1, 1, 16, 1, 1, name='fire2_conv1x1_1')
				 .conv(1, 1, 64, 1, 1, name='fire2_conv1x1_2'))

			(self.feed('fire2_conv1x1_1')
				 .conv(3, 3, 64, 1, 1, name='fire2_conv3x3_2'))

			(self.feed('fire2_conv1x1_2', 
					   'fire2_conv3x3_2')
				 .concat(3, name='fire2_concat')
				 .conv(1, 1, 16, 1, 1, name='fire3_conv1x1_1')
				 .conv(1, 1, 64, 1, 1, name='fire3_conv1x1_2'))

			(self.feed('fire3_conv1x1_1')
				 .conv(3, 3, 64, 1, 1, name='fire3_conv3x3_2'))

			(self.feed('fire3_conv1x1_2', 
					   'fire3_conv3x3_2')
				 .concat(3, name='fire3_concat')
				 .conv(1, 1, 32, 1, 1, name='fire4_conv1x1_1')
				 .conv(1, 1, 128, 1, 1, name='fire4_conv1x1_2'))

			(self.feed('fire4_conv1x1_1')
				 .conv(3, 3, 128, 1, 1, name='fire4_conv3x3_2'))

			(self.feed('fire4_conv1x1_2', 
					   'fire4_conv3x3_2')
				 .concat(3, name='fire4_concat')
				 .max_pool(3, 3, 2, 2, padding='VALID', name='pool4')
				 .conv(1, 1, 32, 1, 1, name='fire5_conv1x1_1')
				 .conv(1, 1, 128, 1, 1, name='fire5_conv1x1_2'))

			(self.feed('fire5_conv1x1_1')
				 .conv(3, 3, 128, 1, 1, name='fire5_conv3x3_2'))

			(self.feed('fire5_conv1x1_2', 
					   'fire5_conv3x3_2')
				 .concat(3, name='fire5_concat')
				 .conv(1, 1, 48, 1, 1, name='fire6_conv1x1_1')
				 .conv(1, 1, 192, 1, 1, name='fire6_conv1x1_2'))

			(self.feed('fire6_conv1x1_1')
				 .conv(3, 3, 192, 1, 1, name='fire6_conv3x3_2'))

			(self.feed('fire6_conv1x1_2', 
					   'fire6_conv3x3_2')
				 .concat(3, name='fire6_concat')
				 .conv(1, 1, 48, 1, 1, name='fire7_conv1x1_1')
				 .conv(1, 1, 192, 1, 1, name='fire7_conv1x1_2'))

			(self.feed('fire7_conv1x1_1')
				 .conv(3, 3, 192, 1, 1, name='fire7_conv3x3_2'))

			(self.feed('fire7_conv1x1_2', 
					   'fire7_conv3x3_2')
				 .concat(3, name='fire7_concat')
				 .conv(1, 1, 64, 1, 1, name='fire8_conv1x1_1')
				 .conv(1, 1, 256, 1, 1, name='fire8_conv1x1_2'))

			(self.feed('fire8_conv1x1_1')
				 .conv(3, 3, 256, 1, 1, name='fire8_conv3x3_2'))

			(self.feed('fire8_conv1x1_2', 
					   'fire8_conv3x3_2')
				 .concat(3, name='fire8_concat')
				 .max_pool(3, 3, 2, 2, padding='VALID', name='pool8')
				 .conv(1, 1, 64, 1, 1, name='fire9_conv1x1_1')
				 .conv(1, 1, 256, 1, 1, name='fire9_conv1x1_2'))

			(self.feed('fire9_conv1x1_1')
				 .conv(3, 3, 256, 1, 1, name='fire9_conv3x3_2'))

			(self.feed('fire9_conv1x1_2', 
					   'fire9_conv3x3_2')
				 .concat(3, name='fire9_concat')
				 .dropout(self.keep_prob, name='drop9')
				 .conv(1, 1, self.cfgs['nb_classes'], 1, 1, relu=False, padding='SAME', name='conv_final')
				 .avg_pool(13, 13, 1, 1, padding='VALID', name='pool_final')
			...
			self.init = False
			self.io.print_error('Error defining model {}'.format(err))
		#try
